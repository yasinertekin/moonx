...
enum ProjectPadding {
  ...
  /// Padding only top left
  EdgeInsetsGeometry get _paddingOnlyTopLeft =>
      EdgeInsets.only(top: _value, left: _value);

  /// Padding Only Top Left Getter
  EdgeInsetsGeometry get paddingOnlyTopLeft => _paddingOnlyTopLeft;
}
